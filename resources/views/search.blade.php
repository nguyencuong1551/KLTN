@extends('layouts.app')
<title>Tìm thấy {{count($products)}} sản phẩm '{{$request -> key}}'</title>
@section('content')
    <!doctype html>
    <html lang="en">
    <head>
            ...
            <form action="{{Route('search')}}" method="post">
                ...
                <nav class="navbar navbar-dark bg-dark flex-md-nowrap">
                    ...
                    <input name="key" class="form-control form-control-dark w-100" type="text"
                           placeholder="Tìm sản phẩm, thương hiệu và giá tiền"
                           aria-label="Search">
        ...
        <div class="row">
            <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                <div class="sidebar-sticky">
                    ...
                    @endforeach
                    <hr class="mb-4">
                    <a href="{{Route('quangcao')}}"><center><img src="https://bizweb.dktcdn.net/100/329/122/themes/681013/assets/banner_1_fashion.png?1557221943833"
                                                                 width="205" height="530"></center>
                    </a>
                </div>
            </nav>
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="https://media3.scdn.vn/img3/2019/4_19/fs7H9j.jpg" width="100%" height="250px">
                        </div>
                        <div class="carousel-item">
                            <img src="https://media3.scdn.vn/img3/2019/4_17/LJUfPO.jpg" width="100%" height="250px">
                        </div>
                        <div class="carousel-item">
                            <img src="https://media3.scdn.vn/img3/2019/4_22/p9Mcs9.jpg" width="100%" height="250px">
                        </div>
                        <div class="carousel-item">
                            <img src="https://media3.scdn.vn/img3/2019/4_12/Hxr0Mt.png" width="100%" height="250px">
                        </div>
                        <div class="carousel-item">
                            <img src="https://media3.scdn.vn/img3/2019/4_26/oD3ZoP.png" width="100%" height="250px">
                        </div>
                        <div class="carousel-item">
                            <img src="https://media3.scdn.vn/img3/2019/3_21/npjVr3.png" width="100%" height="250px">
                        </div>
                        <div class="carousel-item">
                            <img src="https://media3.scdn.vn/img3/2019/4_24/OpO6uH.png" width="100%" height="250px">
                        </div>
                        <div class="carousel-item">
                            <img src="https://media3.scdn.vn/img3/2019/4_24/UbY3D9.jpg" width="100%" height="250px">
                        </div>
                        <div class="carousel-item">
                            <img src="https://media3.scdn.vn/img3/2019/5_4/lRYvUA.jpg" width="100%" height="250px">
                        </div>
                        <div class="carousel-item">
                            <img src="https://media3.scdn.vn/img3/2019/4_22/ZsKVSR.jpg" width="100%" height="250px">
                        </div>
                    </div>
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h2 class="text-danger">Tìm thấy {{count($products)}} sản phẩm cho từ khóa '{{$request -> key}}'</h2>
                </div>
            @if(session('mess'))
                    <br>
                            ...
                            <div class="col-3">
                                <div class="card flex-row mb-2 shadow-sm h-md-150">
                                    <div class="card-body d-flex flex-column align-items-start">
                                        ...
                                        <div class="text-muted">Giá: <strike>{{$product->unit_price}}$</strike></div>
